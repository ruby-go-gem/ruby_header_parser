...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<mutant>.freeze, ["~> 0.12.2".freeze])
  s.add_development_dependency(%q<mutant-rspec>.freeze, ["~> 0.12.2".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.9".freeze])
  s.add_development_dependency(%q<rspec-core>.freeze, ["~> 3.9".freeze])
